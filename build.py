...
def portrait_hero(p):
  ...
  <div class="thero-grid">
    <div class="thero-words rv">
      <div class="eyebrow"><span class="marker">{p['city']}, {p['state']}</span></div>
...
def feed_band(cls='alt'):
    ...
    for f in FEED:
      ...
      <div class="feed-words"><h3>{f['title']}</h3><p class="serif">{f['line']}</p></div>
    </li>'''
    return f'''<section class="feed{" " + cls if cls else ""}"><div class="wrap">
  <div class="section-head rv"><div class="eyebrow"><span class="marker">from the feed</span></div>
  <h2 class="tall">Straight off the <em class="pop">phone</em></h2>
  <p class="lead serif">Reels as he posted them, interface and all &mdash; nothing re-cut and
...
{film_band('film-capabilities', 'the showreel',
           ...
           title='How high will <em class="pop">you go?</em>', loop=True)}
...
{film_band('film-open-air-gallery', 'the studio film',
           ...
           title='The <em class="pop">film</em>')}
