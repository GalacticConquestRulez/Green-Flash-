...
(function () {
  ...
  // There is no hamburger to bind: the menu runs across the top of the
  // screen at every width now (Overall Murals, CLAUDE.md round three), and
  // on a phone the row of links scrolls sideways under the thumb. The panel
  // it used to open, and the toggle that opened it, are both gone.
