...
const NAV = [
  ...
  { to: "/apps", label: "Apps", activeOn: "/apps" },
        ...
        <nav className="hidden items-center gap-4 md:flex lg:gap-7" aria-label="Primary">
          ...
          <div className="relative" ref={moreRef}>
            ...
            {moreOpen ? (
              <div
                role="menu"
                className="absolute right-0 top-full mt-3 w-48 overflow-hidden rounded-xl border border-border bg-background p-1.5 shadow-[0_16px_48px_rgba(0,0,0,0.55)]"
              >
                {MORE.map((item) =>
                  item.external ? (
                    <a
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            ...
            <li>
              <a href="mailto:greenflashusa@gmail.com" className="text-muted hover:text-flash">
